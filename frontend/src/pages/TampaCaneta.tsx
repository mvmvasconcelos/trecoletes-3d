...
export default function TampaCaneta() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            const res = await axios.post(`${API_BASE}/api/generate_parametric/tampa_caneta`, form);
            if (res.data?.files) {
    ...
    const handleBatchGenerate = async () => {
        ...
        try {
            ...
            const res = await axios.post(`${API_BASE}/api/generate_batch/tampa_caneta`, form);
