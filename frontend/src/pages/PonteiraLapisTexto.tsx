...
import { Type, Sliders, ChevronDown, ChevronRight, Home } from 'lucide-react';
...
export default function PonteiraLapisTexto() {
    ...
    useEffect(() => {
        axios.get(`${API_BASE}/api/models/ponteira_lapis_texto/config`)
            .then(res => {
                const cfg = res.data;
                setConfig(cfg);
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            const res = await axios.post(`${API_BASE}/api/generate_parametric/ponteira_lapis_texto`, form);
            if (res.data?.files) {
    ...
    const handleBatchGenerate = async () => {
        ...
        try {
            ...
            const res = await axios.post(`${API_BASE}/api/generate_batch/ponteira_lapis_texto`, form);
    ...
    return (
        <Layout title="Ponteira Lapis Texto">
                    ...
                    <div className="border-t border-neutral-800 pt-3 space-y-2">
                        ...
                        {batchTmfUrl && (
                            <div className="space-y-1.5">
                                ...
                                <button
                                    type="button" onClick={() => downloadBlob(batchTmfUrl!, 'ponteira_texto_lote.zip')}
            ...
            <section className="flex-1 p-4 relative min-w-0 min-h-0 flex flex-col gap-3">
                ...
                {tmfUrl && (
                    <div className="flex-shrink-0 flex flex-col items-center gap-1">
                        ...
                        <button
                            onClick={() => downloadBlob(tmfUrl!, 'ponteira_texto_all.3mf')}
