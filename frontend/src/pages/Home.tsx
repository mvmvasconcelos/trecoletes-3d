    ...
    <div className="min-h-screen bg-neutral-900 text-neutral-200 font-sans p-8 flex flex-col items-center">
      ...
      <div className="w-full max-w-4xl mb-8">
        ...
        <Link to="/chaveiro-simples" className="group rounded-xl border border-neutral-800 bg-neutral-950 p-6 flex flex-col gap-4 hover:border-emerald-500 hover:shadow-lg hover:shadow-emerald-900/20 transition-all">
          <img
            src={`${import.meta.env.BASE_URL}chaveiro_simples_plate_1.png`}
        ...
        <Link to="/tampa-bic" className="group rounded-xl border border-neutral-800 bg-neutral-950 p-6 flex flex-col gap-4 hover:border-emerald-500 hover:shadow-lg hover:shadow-emerald-900/20 transition-all">
          <div className="w-12 h-12 rounded-lg bg-emerald-900/30 flex items-center justify-center text-emerald-500 group-hover:scale-110 transition-transform">
            <PenLine className="w-6 h-6" />
          </div>
          <div>
            <h2 className="text-xl font-bold text-neutral-100 group-hover:text-emerald-400 transition-colors">Tampa BIC</h2>
            <p className="text-neutral-500 mt-2 text-sm">Nova versão de tampa com BOSL2, cápsula fixa à direita e linhas primária/secundária configuráveis.</p>
          </div>
        </Link>
        ...
        <Link to="/carimbo-relevo-svg" className="group rounded-xl border border-neutral-800 bg-neutral-950 p-6 flex flex-col gap-4 hover:border-emerald-500 hover:shadow-lg hover:shadow-emerald-900/20 transition-all">
          <div className="w-12 h-12 rounded-lg bg-emerald-900/30 flex items-center justify-center text-emerald-500 group-hover:scale-110 transition-transform">
            <Stamp className="w-6 h-6" />
          </div>
          <div>
            <h2 className="text-xl font-bold text-neutral-100 group-hover:text-emerald-400 transition-colors">Carimbo em Relevo SVG</h2>
            <p className="text-neutral-500 mt-2 text-sm">Gere um carimbo dobradiçado com relevo positivo e cavidade negativa a partir de uma arte SVG.</p>
          </div>
        </Link>
        ...
        <Link to="/letreiro-social" className="group rounded-xl border border-neutral-800 bg-neutral-950 p-6 flex flex-col gap-4 hover:border-emerald-500 hover:shadow-lg hover:shadow-emerald-900/20 transition-all">
          <div className="w-12 h-12 rounded-lg bg-emerald-900/30 flex items-center justify-center text-emerald-500 group-hover:scale-110 transition-transform">
      ...
      <div className="w-full max-w-4xl">
        ...
        <Link to="/editor-2d" className="group rounded-xl border border-neutral-800 bg-neutral-950 p-6 flex flex-col gap-4 hover:border-sky-500 hover:shadow-lg hover:shadow-sky-900/20 transition-all">
          <div className="w-12 h-12 rounded-lg bg-sky-900/30 flex items-center justify-center text-sky-500 group-hover:scale-110 transition-transform">
        ...
        <Link to="/conversor-png-svg" className="group rounded-xl border border-neutral-800 bg-neutral-950 p-6 flex flex-col gap-4 hover:border-sky-500 hover:shadow-lg hover:shadow-sky-900/20 transition-all">
          ...
          <div>
            <h2 className="text-xl font-bold text-neutral-100 group-hover:text-sky-400 transition-colors">Conversor de Imagem → SVG</h2>
            <p className="text-neutral-500 mt-2 text-sm">Suba uma imagem (PNG, JPEG, SVG...) e baixe o SVG vetorizado, com ajuste de espessura de linha.</p>
          </div>
        </Link>
        </div>
      </div>
